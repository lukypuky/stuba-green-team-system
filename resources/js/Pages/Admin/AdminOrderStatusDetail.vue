        ...
        <div class="container page-container">
            <div class="mx-auto grid grid-cols-12 gap-4 p-1">
                ...
                <div class="col-span-12 sm:col-span-10">
                    ...
                    <div class="page-heading">
                        <div class="heading-container">
                            <div class="heading-right-margin">
                                <h1>Upraviť záznam (Stav objednávky)</h1>
                            </div>
                    ...
                    <div class="cards">
                        <input type="hidden" name="id" v-model="this.orderStatus[0].id" />
                        <div class="card bg-gray-100">
                            <div class="card-row">
                                <div>Názov: </div>
                                <div>
                                    <input type="text" v-model="this.orderStatus[0].order_status_title" :disabled="inputEnable"
                                        ...
                                        id="order_status_title"/>
                                    <div v-if="$page.props.errors.order_status_title" class="text-red-500">
                                        {{ $page.props.errors.order_status_title }}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                inputEnable: true,
                tmpObject: {
                    order_status_title: this.orderStatus[0].order_status_title,
                },
            }
        },
        methods: {
            ...
            reset(){
                ...
                this.orderStatus[0].order_status_title = this.tmpObject.order_status_title;
            },
            update(){
                this.inputEnable = true;

                Inertia.post(route("dashboard-update-order-status"), this.orderStatus[0]);
            },
        },
        computed: {
            showAlert() {
