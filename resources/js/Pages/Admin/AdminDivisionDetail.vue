            ...
            <div class="mx-auto grid grid-cols-12 gap-4 p-1">
                ...
                <div class="col-span-12 sm:col-span-10">
                    ...
                    <div class="admin-cards">
                        <input type="hidden" name="id" v-model="this.division[0].id" />
                        <div class="admin-card bg-transparent">
                            <div class="admin-card-row">
                                <div>Názov: <span class="text-red-500">*</span></div>
                                <div>
                                    <input type="text" v-model="this.division[0].division_title" :disabled="inputEnable"
                                        ...
                                        id="division_title"/>
                                    <div v-if="$page.props.errors.division_title" class="text-red-500">
                                        {{ $page.props.errors.division_title }}
                                    </div>
                                </div>
                            </div>
                            <div class="admin-card-row">
                                <div>Skratka: </div>
                                <div>
                                    <input type="text" v-model="this.division[0].shortcut" :disabled="inputEnable"
                                        class="mt-1 shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline"
                                        id="shortcut"/>
                                </div>
                            </div>
    ...
    export default {
        ...
        data() {
            return {
                inputEnable: true,
                tmpObject: {
                    division_title: this.division[0].division_title,
                    shortcut: this.division[0].shortcut,
                },
            }
        },
        methods: {
            ...
            reset(){
                ...
                this.division[0].division_title = this.tmpObject.division_title;
                this.division[0].shortcut = this.tmpObject.shortcut;
            },
            update(){
                this.inputEnable = true;

                Inertia.post(route("dashboard-update-division"), this.division[0]);
            },
        },
        computed: {
            showAlert() {
