                ...
                <div class="col-span-12 sm:col-span-10">
                    ...
                    <div class="mb-3">
                        <div class="leading-10">
                            <Link :href="route('dashboard-get-currency-store-page')" class="buttons">Pridať záznam</Link>
                        </div>
                    </div>
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b-2 border-gray-200">
                                <tr>
                                    ...
                                    <th class="p-3 text-sm font-semibold tracking-wide text-left">Skratka</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-100">
                                <tr class="bg-white" v-for="(currency, index) in this.currencies.data" :key="index">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:hidden mb-2 text-sm" v-for="(currency, index) in this.currencies.data" :key="index">
