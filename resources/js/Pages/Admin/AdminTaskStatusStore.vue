                    ...
                    <div class="page-heading">
                        <div class="heading-container">
                            <div class="heading-right-margin">
                                <h1>Pridať záznam (Stav úlohy)</h1>
                            </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="cards">
                        <div class="card bg-gray-100">
                            <div class="card-row">
                                ...
                                <div>
                                    <input type="text" v-model="this.tmpObject.task_status_title"
...
<script>
    ...
    export default {
        ...
        methods: {
            add(){
                Inertia.post(route("dashboard-store-task-status"), this.tmpObject);
            },
        },
    }
</script>
