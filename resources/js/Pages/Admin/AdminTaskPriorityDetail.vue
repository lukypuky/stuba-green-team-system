                ...
                <div class="col-span-12 sm:col-span-10">
                    <div class="page-heading mb-0">
                        <div class="flex justify-between mb-3">
                            <div>
                                <h1>Upraviť záznam (Priorita úlohy)</h1>
                            </div>
                            <div class="md:hidden">
    ...
    export default {
        ...
        data() {
            return {
                inputEnable: true,
                tmpObject: {
                    task_priority_title: this.taskPriority[0].task_priority_title,
                },
            }
        },
        methods: {
            ...
            reset(){
                ...
                this.taskPriority[0].task_priority_title = this.tmpObject.task_priority_title;
            },
            update(){
                this.inputEnable = true;

                Inertia.post(route("dashboard-update-task-priority"), this.taskPriority[0]);
            },
        },
        computed: {
            showAlert() {
