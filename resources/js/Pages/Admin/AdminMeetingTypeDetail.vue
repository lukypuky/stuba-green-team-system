                ...
                <div class="col-span-12 sm:col-span-10">
                    <div class="page-heading mb-0">
                        <div class="flex justify-between mb-3">
                            <div>
                                <h1>Upraviť záznam (Typ stretnutia)</h1>
                            </div>
                            <div class="md:hidden">
                    ...
                    <div class="admin-cards">
                        <input type="hidden" name="id" v-model="this.meetingType[0].id" />
                        <div class="admin-card bg-transparent">
                            <div class="admin-card-row">
                                <div>Názov: <span class="text-red-500">*</span></div>
                                <div>
                                    <input type="text" v-model="this.meetingType[0].meeting_type_title" :disabled="inputEnable"
                                    ...
                                    <div v-if="$page.props.errors.meeting_type_title" class="text-red-500">
                                        {{ $page.props.errors.meeting_type_title }}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                inputEnable: true,
                tmpObject: {
                    meeting_type_title: this.meetingType[0].meeting_type_title,
                },
            }
        },
        methods: {
            ...
            reset(){
                ...
                this.meetingType[0].meeting_type_title = this.tmpObject.meeting_type_title;
            },
            update(){
                this.inputEnable = true;

                Inertia.post(route("dashboard-update-meeting-type"), this.meetingType[0]);
            },
        },
        computed: {
            showAlert() {
