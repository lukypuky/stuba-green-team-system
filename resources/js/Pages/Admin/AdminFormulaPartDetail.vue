        ...
        <div class="container page-container">
            <div class="mx-auto grid grid-cols-12 gap-4 p-1">
                ...
                <div class="col-span-12 sm:col-span-10">
                    ...
                    <div class="page-heading">
                        <div class="heading-container">
                            <div class="heading-right-margin">
                                <h1>Upraviť záznam (Časť formuly)</h1>
                            </div>
                    ...
                    <div class="cards">
                        <input type="hidden" name="id" v-model="this.formulaPart[0].id" />
                        <div class="card bg-gray-100">
                            <div class="card-row">
                                <div>Názov: </div>
                                <div>
                                    <input type="text" v-model="this.formulaPart[0].formula_part_specify_title" :disabled="inputEnable"
                                        ...
                                        id="formula_part_specify_title"/>
                                    <div v-if="$page.props.errors.formula_part_specify_title" class="text-red-500">
                                        {{ $page.props.errors.formula_part_specify_title }}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                inputEnable: true,
                tmpObject: {
                    formula_part_specify_title: this.formulaPart[0].formula_part_specify_title,
                },
            }
        },
        methods: {
            ...
            reset(){
                ...
                this.formulaPart[0].formula_part_specify_title = this.tmpObject.formula_part_specify_title;
            },
            update(){
                this.inputEnable = true;

                Inertia.post(route("dashboard-update-formula-part"), this.formulaPart[0]);
            },
        },
        computed: {
            showAlert() {
