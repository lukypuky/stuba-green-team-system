        ...
        <div class="container page-container">
            <div class="mx-auto grid grid-cols-12 gap-4 p-1">
                ...
                <div class="col-span-12 sm:col-span-10">
                    ...
                    <div class="cards">
                        <input type="hidden" name="id" v-model="this.area[0].id" />
                        <div class="card bg-gray-100">
                            <div class="card-row">
                                <div>Názov: </div>
                                <div>
                                    <input type="text" v-model="this.area[0].area_title" :disabled="inputEnable"
                                        ...
                                        id="area_title"/>
                                    <div v-if="$page.props.errors.area_title" class="text-red-500">
                                        {{ $page.props.errors.area_title }}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        data() {
            return {
                inputEnable: true,
                tmpObject: {
                    area_title: this.area[0].area_title,
                },
            }
        },
        methods: {
            ...
            reset(){
                ...
                this.area[0].area_title = this.tmpObject.area_title;
            },
            update(){
                this.inputEnable = true;

                Inertia.post(route("dashboard-update-area"), this.area[0]);
            },
        },
        computed: {
            showAlert() {
