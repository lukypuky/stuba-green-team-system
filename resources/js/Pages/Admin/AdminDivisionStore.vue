                    ...
                    <div class="cards">
                        <div class="card bg-gray-100">
                            <div class="card-row">
                                ...
                                <div>
                                    <input type="text" v-model="this.tmpObject.division_title"
...
<script>
    ...
    export default {
        ...
        methods: {
            add(){
                Inertia.post(route("dashboard-store-division"), this.tmpObject);
            },
        },
    }
</script>
